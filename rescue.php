...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Bind parameters: integer (i), string (s), string (s), string (s), double (d), double (d), string (s), string (s), string (s)
    // Note: latitude/longitude are decimals in DB, treated as double here. nullable fields need care.
    // If null, we might need separate handling or use 'd' with variable holding null ? No, bind_param typically expects variables.
...
<head>
    ...
    <title>Report a Rescue - Paw Pal</title>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-10">
                    ...
                    <a href="rescue.php"
                        class="text-sm uppercase tracking-widest text-paw-alert transition-colors">Rescue</a>
                    <a href="centers.php"
