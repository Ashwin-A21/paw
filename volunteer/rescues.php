...
<head>
    ...
    <title>Rescue Reports - Paw Pal</title>
...
<body class="font-sans text-paw-dark antialiased bg-paw-bg transition-colors duration-300">
    ...
    <!-- Confirmation Modal -->
    <div id="rescueModal" class="fixed inset-0 bg-black/50 z-50 hidden flex items-center justify-center">
                                ...
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        ...
                                        <form method="POST" class="status-form">
                                            ...
                                            <input type="hidden" name="update_status" value="1">
                                            <select name="status"
                                                onchange="handleStatusChange(this, <?php echo $rescue['id']; ?>)"
