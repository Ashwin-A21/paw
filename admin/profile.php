...
<head>
    ...
    <title>Admin Profile - Paw Pal</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-paw-dark text-white flex flex-col">
            ...
            <nav class="flex-1 p-4">
                ...
                <a href="pets.php"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl text-white/70 hover:bg-white/5 hover:text-white mb-2 transition-colors"><i
                        data-lucide="heart" class="w-5 h-5"></i> Manage Pets</a>
                <a href="users.php"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl text-white/70 hover:bg-white/5 hover:text-white mb-2 transition-colors"><i
                        data-lucide="users" class="w-5 h-5"></i> Users</a>
                <a href="profile.php"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/10 text-white mb-2"><i
                        data-lucide="user-circle" class="w-5 h-5"></i> My Profile</a>
            </nav>
